...
This post is a deep dive into how `TensorIterator` works, and is
...
Also have a look at [this blog post](https://github.com/pytorch/pytorch/wiki/How-to-use-TensorIterator) from the PyTorch team
